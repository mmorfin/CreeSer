<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="frmRazonesCambioOT.aspx.cs" Inherits="catalog_frmRazonesCambioOT" EnableEventValidation="false" ValidateRequest="false" %>
    ...
    <div class="grid">
        ...
        <select class="pagesize cajaCh" style="width: 50px; min-width: 50px; max-width: 50px;">
            ...
            <asp:GridView ID="gvRazon" 
                ...
                CssClass="gridView" 
                DataKeyNames="idRazonCancelarOT" 
