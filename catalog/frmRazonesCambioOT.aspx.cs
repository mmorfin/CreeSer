...
public partial class catalog_frmRazonesCambioOT : BasePage
{
    ...
    private void cargaDatos()
    {
        ...
        try
        {
            DataSet ds = DataAccess.executeStoreProcedureDataSet("spr_GET_RazonesCancelarOT", parameters, this.Session["connection"].ToString());
    ...
    protected void Guardar_Actualizar(object sender, EventArgs e)
    {
        ...
        try
        {
            DataSet ds = DataAccess.executeStoreProcedureDataSet("spr_INSERT_RazonesCancelarOT", parameters, this.Session["connection"].ToString());
    ...
    protected void gvRazon_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            dt = DataAccess.executeStoreProcedureDataTable("spr_GET_RazonesCancelarOT", parameters, this.Session["connection"].ToString());
        }
        catch (Exception ex)
        {
            Log.Error(ex);
