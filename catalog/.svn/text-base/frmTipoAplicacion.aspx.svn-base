<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="frmTipoAplicacion.aspx.cs" enableEventValidation="false" Inherits="catalog_frmTipoAplicacion" ValidateRequest="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            if ($("#<%=gvTipoAplicacion.ClientID%>").find("tbody").find("tr").size() > 1) {

                $("#<%=gvTipoAplicacion.ClientID%>")
                    .tablesorter({
                        widthFixed: true,
                        widgets: ['zebra'],
            ...
            $('#' + formId).validate({
                ...
                messages: {
                    '<%=txtNombre.UniqueID%>': { required: '<%=(string)GetLocalResourceObject("nameRequired")%>' }
                },
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <h1>
    <asp:Label ID="lblBienvenido" runat="server" meta:resourceKey="lblBienvenido">Tipos de Aplicaci&oacute;n</asp:Label></h1>
    <table class="index">
        <tr>
    ...
    <div class="grid">
        ...
        <select class="pagesize cajaCh" style="width: 50px; min-width: 50px; max-width: 50px;">
            ...
            <asp:GridView ID="gvTipoAplicacion" runat="server" 
                AutoGenerateColumns="False" CssClass="gridView" DataKeyNames="idTipoAplicacion" 
            EmptyDataText="No existen registros" Width="800px"
            onpageindexchanging="gvTipoAplicacion_PageIndexChanging" 
            onprerender="gvTipoAplicacion_PreRender" onrowdatabound="gvTipoAplicacion_RowDataBound" onselectedindexchanged="gvTipoAplicacion_SelectedIndexChanged"
            meta:resourceKey="gvTipoAplicacion" >
                <Columns>
